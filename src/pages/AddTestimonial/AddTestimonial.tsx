...
import {
  Box, Container, Heading, Stack, Text, SimpleGrid,
  Flex
    ...
    <Container maxW="100%" py={{ base: 10, md: 12 }} px={8}>
          ...
          <Box
            ...
            maxW={{ lg: "46%" }}>
                <Text textStyle={"size-2xl"}>
                  You are about to post a comment on our “testimonial board”.If you need to contact customer service please 
                  <Text as="span" mx={1} cursor="pointer" color="brand.primary" onClick={() => navigate("/contact-us")}>email us</Text>. 
      ...
      >
        ...
        <Stack gap={4}>
          ...
          <Button
            label="Send" variant='primary' onClick={handleSubmit} px="16" 
          />
          </Box>
