...
export const quoteIncludesData = [
  {
    icon: FaHandshake,
    text: "Your consumer rights with the BBB and SMA",
  },
  {
    icon: FaShieldAlt,
    text: "$50,000 bond",
 ...
 {
  icon: FaWrench,
  text: "In-house repair or replacement policy for damaged items",
},
{
  icon: FaTools,
  text: "Free disassembly & reassembly of standard furniture",
},
  {
    icon: FaCouch,
