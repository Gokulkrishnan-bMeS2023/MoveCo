...
const policyImages = {
  personalInfo: images.personalInformation,
  email: images.email,
  cookies: images.cookiesAndTag,
  linking: images.linking,
...
export const POLICY_DATA: PolicyItem[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "There are some locations on MoveCo.net’s websites where we have made special provisions for a more secure environment in which we can exchange information with you. At each of these locations, we will provide you with appropriate instructions.",
    ],
  },
  {
  ...
  },
  {
    ...
    reverse: true,
    content: [
      "From time to time, MoveCo.net websites may provide links to other websites, not owned or controlled by MoveCo.net, that we think might be useful or of interest to you. We cannot, however, be responsible for the privacy practices used by other website owners or the content or accuracy of those other websites. Links to various non-MoveCo.net websites do not constitute or imply endorsement by MoveCo.net of these websites, any products or services described on these sites, or of any other material contained in them.",
    ],
  },
  {
    title: "Security",
    ...
    content: [
      "MoveCo.net has adopted and adheres to stringent security standards designed to protect non-public personal information at MoveCo.net.com against accidental or unauthorized access or disclosure. Among the safeguards that MoveCo.net has developed for this site are administrative, physical and technical barriers that together form a protective firewall around the information stored at this site. We periodically subject our site to simulated intrusion tests and have developed comprehensive disaster recovery plans.",
    ],
  },
  {
