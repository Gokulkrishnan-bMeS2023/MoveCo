...
const MainBanner = () => {
  ...
  return (
    <>
      ...
      <Box
        display={{ base: "none", lg: "block" }}
        position="relative"        // ✅ only added
        minHeight="82vh"
        borderRadius="xl"
        overflow="hidden"          // ✅ only added
      >
        {/* ✅ replaced backgroundImage with this */}
        <Image
          src={images.mainBannerBg}
          alt="Professional Pack/Unpack Services"
          position="absolute"
          top={0}
          left={0}
          width="100%"
      ...
      >
        ...
        <Stack gap={4} position="relative" zIndex={1}>  {/* ✅ only added position+zIndex */}
          <Heading as="h2">
            Your Authentic Professional Pack/Unpack Services
          </Heading>
          <Text textStyle={"size-md"}>
